...
import com.zjh.gulimall.product.dao.ProductAttrValueDao;
import com.zjh.gulimall.product.entity.ProductAttrValueEntity;
import com.zjh.gulimall.product.service.ProductAttrValueService;
...
public class ProductAttrValueServiceImpl extends ServiceImpl<ProductAttrValueDao, ProductAttrValueEntity> implements ProductAttrValueService {
    ...
    public List<ProductAttrValueEntity> baseAttrlistforspu(Long spuId) {
        List<ProductAttrValueEntity> entities = this.baseMapper
                .selectList(new QueryWrapper<ProductAttrValueEntity>()
                        .eq("spu_id", spuId));
        return entities;
    }
